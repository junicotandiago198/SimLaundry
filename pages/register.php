        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?= $baseUrl2; ?>pages/aksi/register.php">
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      $kota = mysqli_query($koneksi,"SELECT * FROM tb_kota");
                ...
                <div class="form-group col-6">
                      ...
                      <input id="last_name" type="text" class="form-control" name="no_hp">
                    </div>
                  </div>
